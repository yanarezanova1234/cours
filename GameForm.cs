...
namespace WinFormsApp1
{
    public partial class GameForm : Form
    {
        ...
        public Dictionary<string, Panel> dictOfPanels = new Dictionary<string, Panel>(); // Словарь для связи имен клеток и панелей на форме
        ...
        public void DrawBoard(Dictionary<string, Cell> dictOfCells)
        {
            foreach (KeyValuePair<string, Cell> item in dictOfCells)
            {
                ...
                if (item.Value.CellColor == WHITE) dictOfPanels[item.Value.CellName].BackColor = Color.PaleGreen;
                else dictOfPanels[item.Value.CellName].BackColor = Color.LightCyan;
        ...
        {
            WHITE_CHECKER = new Bitmap(new Bitmap(@"C:\Users\yanch\OneDrive\Рабочий стол\уник\тмп\w.png"), new Size(54,54));
            BLACK_CHECKER = new Bitmap(new Bitmap(@"C:\Users\yanch\OneDrive\Рабочий стол\уник\тмп\b.png"), new Size(54,54));
            Image im;
